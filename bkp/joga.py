...
if __name__ == '__main__':    
    ...
    scrap_current_week_to_csv('out.csv', snow ,u'Jóga modrý sál', append=True)
    scrap_current_week_to_csv('out.csv', snow, u'Jóga zelený sál', append=True)
    scrap_current_week_to_csv('out.csv', snow, u'Hot-joga', append=True)
